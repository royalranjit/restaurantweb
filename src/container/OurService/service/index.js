...
import OkImage from "./Group 9.png";
  ...
  return (
    <div className={styles.Service_container}>
      <div className="text_container">
        <p className="text-[#0C6967] text-[56px] font-[400] italic">Our Services</p>
        <p className="text-[#6B788E] text-[24px] font-[300] tracking-[0.12em] mt-[40px] ">KNOWING OUR CUSTOMERS NEEDS</p>
